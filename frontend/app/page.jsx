...
const features = [
  {
    icon: <Zap size={22} />,
    title: "Bulk Sending",
    desc: "Send to hundreds of contacts at once with smart delays.",
  },
  {
    icon: <Bot size={22} />,
    title: "AI Messages",
    desc: "Describe your message — AI writes it for you instantly.",
  },
  {
    icon: <Shield size={22} />,
    title: "Anti-Ban Built In",
    desc: "Random delays and unique messages keep your account safe.",
  },
  {
    icon: <BarChart2 size={22} />,
    title: "Live Progress",
    desc: "Watch sent, failed, and skipped update in real time.",
  },
  {
    icon: <Users size={22} />,
    title: "Multi-User",
    desc: "Each user has their own WhatsApp session and history.",
  },
  {
    icon: <MessageSquare size={22} />,
    title: "Full History",
    desc: "Every message logged — filter by status, export anytime.",
  },
];
...
const steps = [
  { num: "01", title: "Sign Up", desc: "Create your account in seconds." },
  {
    ...
    desc: "Scan QR once — session saved forever.",
  },
  {
    num: "03",
    title: "Send Messages",
    desc: "Upload numbers, write or AI-generate message, send.",
  },
];
...
const testimonials = [
  ...
  {
    quote:
      "The hero and preview card do the selling before the copy even starts.",
    ...
    <div className="min-h-screen bg-[#070b09] text-white ">
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid gap-10 lg:gap-14 lg:grid-cols-[1.1fr_0.9fr] items-start lg:items-center">
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-white/65 mb-8 max-w-xl leading-relaxed">
              Write campaigns faster with AI, send them safely with smart
              pacing, and watch every delivery update live from one clean
              dashboard.
            </p>
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              {stats.map((item) => (
                <div
                  key={item.label}
                  className="min-w-[150px] rounded-2xl border border-white/8 bg-white/4 px-4 py-3 backdrop-blur-sm"
                >
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-black font-bold px-7 py-4 rounded-full transition-all text-base shadow-[0_0_24px_rgba(37,211,102,0.22)]"
              >
                Start for Free <ArrowRight size={18} />
              </Link>
              <Link
                href="/login"
                className="inline-flex items-center gap-2 border border-white/12 hover:border-white/24 bg-white/0 hover:bg-white/5 text-white px-7 py-4 rounded-full transition-all text-base"
              >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4 text-sm text-white/50">
              <div className="flex items-center gap-2">
                <BadgeCheck size={16} className="text-[#25D366]" /> Saved
                sessions
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                <Send size={16} className="text-[#25D366]" /> Campaign ready in
                minutes
              </div>
            </div>
          </div>
              ...
              <div className="grid gap-4 p-6">
                <div className="rounded-3xl border border-white/8 bg-[#0f1713] p-5 pop-up">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <p className="text-xs uppercase tracking-[0.24em] text-white/40 mb-1">
                        AI composer
                      </p>
                  ...
                  <div className="mt-4 rounded-2xl bg-[#25D366]/10 border border-[#25D366]/20 p-4 text-sm text-white/90 leading-relaxed">
                    Hey! Happy Diwali. We have a special festive offer just for
                    you. Grab it before it ends.
                  </div>
                </div>
      ...
      <section className="py-20 px-6 md:px-16 max-w-7xl mx-auto pop-up">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-10">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-[#25D366] mb-3">
              Features
            </p>
        ...
        <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="rounded-2xl border border-white/8 bg-white/4 p-6 hover:border-[#25D366]/30 transition-colors"
            >
      ...
      <section className="py-20 px-6 md:px-16 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-white/55">
            Up and running in under 2 minutes, with a cleaner visual story.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {steps.map((step, index) => (
            <div
              key={step.num}
              className="relative rounded-[28px] border border-white/8 bg-white/4 p-7 overflow-hidden"
            >
              <div className="absolute top-0 right-0 px-5 py-3 text-[#25D366]/15 text-6xl font-black">
                {step.num}
              </div>
      ...
      <section className="py-20 px-6 md:px-16 text-center">
        <div className="max-w-3xl mx-auto bg-gradient-to-br from-[#0f1713] to-[#09100c] border border-[#25D366]/20 rounded-[36px] p-10 md:p-14 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight mb-4">
              Ready to launch a better landing flow?
            </h2>
            <p className="text-white/60 mb-8 max-w-2xl mx-auto leading-relaxed">
              This version gives you a real product narrative: proof, preview,
              features, and a stronger call to action.
            </p>
            <Link
              href="/signup"
              className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-black font-bold px-9 py-4 rounded-full transition-all text-base shadow-[0_0_24px_rgba(37,211,102,0.22)]"
            >
